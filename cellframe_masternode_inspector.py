...
from exceptions import UnsupportedNodeVersionError, UnsupportedPlatformError, ConfigurationError
...
def main():
    ...
    if version.parse(system_requests._current_node_version) < version.parse(Config.MIN_NODE_VERSION):
        ...
        raise UnsupportedNodeVersionError("Unsupported node version")
    ...
    if not masternode_helpers._active_networks_config:
        ...
        raise ConfigurationError("No active masternode configuration found")
